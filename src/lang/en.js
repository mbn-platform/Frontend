const en = {
  ...
  'errorTraderNotAvailable' : 'Trader not available',
  ...
  'failedToCancelOrder' : 'Failed to cancel order: {errorCode}',
  'failedToPlaceOrder' : 'failed to place order: {errorCode}',
  'orderHasBeenPlaced' : 'Order has been placed',
  'thisKeyAlreadyInSystem' : 'You can add only one API key from one exchange account',
  'failedToAddApiKey:' : 'failed to add api key: {errorCode}',
  ...
  'roiCalculatedBy': 'ROI CALCULATED BY MBN PLATFORM ANALYSIS SYSTEM',
  ...
  'dashboard.passphrasePlaceholder': 'Passphrase',
  'dashboard.addAlert': 'Enter keyname and key value, select exchange',
  'dashboard.addPassphrase': 'Enter passphrase',
  ...
  'dashboard.apiKeyCurrencies': 'Details',
  'dashboard.availableCurrencies': 'Available currencies',
  'dashboard.apiKeyManagement': 'API KEYs management',
  'dashboard.contractManagement': 'Contracts Management',
  'dashboard.groupManagement': 'Groups Management',
  'dashboard.contractCurrencies': 'Contract currencies',
  'dashboard.exchangeAccounts': 'Connected API',
  ...
  'dashboard.createdGroups': 'Created groups',
  'dashboard.detailsContracts': 'Details/Contracts',
  'dashboard.createNewGroup': 'Create new group',
  'dashboard.addContract': 'Add contract',
  'dashboard.create': 'Create',
  'dashboard.add': 'Add',
  'dashboard.selectGroup': 'Select a group to manage it\'s contracts',
  'dashboard.groupHasNoContracts': 'The selected group has no contracts yet',
  'dashboard.errors.invalidExchange': 'The exchange of this contract is not valid for the selected group',
  'dashboard.errors.contractInOtherGroup': 'This contract is already in another group',
  ...
  'terminal.volumeCurrency': 'Volume',
  ...
  'modal.error': 'Error',
  'modal.error.useYourAddress': 'You have to use your address associated with your MBN Platform account',
  ...
  'history.orders.title': 'Orders',
  'history.contracts.active.title': 'Active Contracts',
