      ...
      <div onClick={() => this.setState({isOpen: !this.state.isOpen})} id="popover1" className="dropdown-link-wrap">
        ...
        >
          <div
            ...
            <div className="dropdown__name" onClick={this.onOutsideClick}>
              <span>
                <FormattedMessage id="terminal.contracts"
            ...
            {contracts.map(c => (
              <div
                key={c._id}
                onClick={e => this.onContractSelect(e, c)}
                className={classNames('key', {active: this.props.selectedFund && this.props.selectedFund._id === c._id})}>
                {this.renderFundName(c)}
              </div>
            ))}
            <div
              key="all selected"
              onClick={e => this.onContractSelect(e, null)}
